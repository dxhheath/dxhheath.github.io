...
function init_searchbar() {
  var search =
    '<form class="searchBox" onSubmit="return searchbar_listener()">' +
...
function searchbar_listener(event) {
  ...
  if (q !== '') {
    var url =
      'https://github.com/dxhheath/dxhheath.github.io/search?utf8=✓&q=' +
  ...
  if (event.which === 13) {
    var q = $('input[name=search]').val();
    if (q !== '') {
      var url = 'https://github.com/dxhheath/dxhheath.github.io/search?utf8=✓&q=' + encodeURIComponent(q);
      location.href = url;
    }
  }
  */
